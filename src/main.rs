...
//             // self.sent_messages.push(String::from(message)); This violates borrow as mut rule
//             self.sent_messages.borrow_mut().push(String::from(message)); // this doesn't, but uses unsafe
//         }
//     }
...
// *******************************************************************************************
// ***** Memory Leaks through Rc and RefCell *****
